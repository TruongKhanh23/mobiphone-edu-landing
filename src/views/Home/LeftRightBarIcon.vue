<template>
  <div>
    ...
    <div
      v-if="isPopupVisible"
      class="absolute top-[53%] left-12 w-fit h-fit overflow-y-auto px-5 py-10 shadow-lg transform -translate-y-1/2 z-10 rounded-lg bg-[#00142C] bg-opacity-[76%] flex items-center flex-col"
    >
      <h1
